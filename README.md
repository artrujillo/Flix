...
https://i.imgur.com/FglKRM7.gifv
...
I encountered a couple weird errors such as "cannot find class symbol" which i resolved w/ the help of the instructors as it was caused by an error w/ another method that was not there.
I also had to deal with some odd formatting errors that Android Studio defaulted to, but after reading syntax and talking with the instructors, I was able to get past this
